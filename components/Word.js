...
// - wordData: The puzzle state for the word, without taking into account user input.
// Any letters here are hint characters. Blank characters MUST BE denoted by '*'.
// - wordState: A WordState. Used to determine the style of the word.
// - input: input forwarded by the keyboard
export default function Word({wordData, wordState, input}) {
    ...
    // now we need to run the program to render words that have been 
    else {
